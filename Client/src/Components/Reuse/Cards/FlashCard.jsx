...
const FlashCard = ({product}) => {
    ...
    return (
        <div className='border rounded-lg flex flex-col ' onMouseEnter={()=>handleHover(true)} onMouseLeave={()=>handleHover(false)}>
            ...
            <div className='p-5 space-y-2'>
               ...
               <button className={`flex justify-center items-center gap-1 w-full bg-color_yellow text-color_primary py-3 rounded-lg  font-semibold transition-all duration-200 ease-in-out ${isHover ? 'mt-0' : '-mt-[120px]'}`}>
